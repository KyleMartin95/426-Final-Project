...
class EventInfo
{
  ...
  private function update() {
    ...
    $result = $mysqli->query("update EventInfo set " .
			     ...
			     "latitude=" .
			     "'" . $mysqli->real_escape_string($this->latitude) . "', " .
			     "longitude=" .
			     "'" . $mysqli->real_escape_string($this->longitude) . "', " .
			     "radius=" .
			     "'" . $mysqli->real_escape_string($this->radius) . "', " .
			     "numberAttending=" .
			     "'" . $mysqli->real_escape_string($this->numberAttending) . "', " .
			     "hostID=" .
			     "'" . $mysqli->real_escape_string($this->hostID) . "', " .
			     "startTime=" . $strt . ", " .
			     "endTime=" . $endt . ", " .
			     "description=" .
